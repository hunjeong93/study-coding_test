...
public class P11438_최소공통조상2_2 {
    ...
    public static void main(String[] args) throws IOException {
        ...
        for (int i = 0; i < N - 1; i++) {  //tree에 데이터 저장
        ...
        int temp = 1;
        kmax = 0;
        while (temp <= N) {  //최대 depth 구하기. 비트 연산자 이용. 2^k 의 k 구하는것
            temp <<= 1;
            kmax++;
        }
        parent = new int[kmax + 1][N + 1]; //parent배열 초기화
        BFS(1); //depth를 BFS를 이용해 구함
