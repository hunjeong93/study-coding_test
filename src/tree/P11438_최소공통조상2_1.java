...
public class P11438_최소공통조상2_1 {
    ...
    public static void main(String[] args) throws IOException {
        ...
        tree = new ArrayList[N + 1]; // 인덱스랑 노드랑 일치
        for (int i = 0; i < N + 1; i ++){
            tree[i] = new ArrayList<Integer>(); //인접 리스트 생성
        }

        for (int i = 0; i < N - 1; i++) { // N 개의 노드가 연결되어있기 때문에 N - 1 번 입력함, 그래프 저장
        ...
        depth = new int[N + 1]; // 각 노드별 깊이 저장 배열
